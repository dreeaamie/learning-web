...
function Purchases() {
  ...
  // No mount-only auth effect: derive auth state from localStorage so UI
  // reflects the current login status when the component renders.
  ...
  // update central auth state and navigate
  logout();
  navigate("/login");
    } catch (error) {
